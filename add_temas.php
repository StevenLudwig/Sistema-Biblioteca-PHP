...
<html>
    ...
    <body>
    	<div class="center" align="center">
            ...
            <form method="post" action="add_tema.php">
                <br><label>Clave de tema </label><input type="number" name="clave" required="required" required placeholder="20112015" pattern="[0-9]{8}" maxlength="8">
