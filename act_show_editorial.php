    ...
    <body>
        <div class="center" align="center">
            ...
            <?php
                ...
                $query = "update editorial set nombre='$nombre',direccion='$direccion',telefono='$telefono' where claveeditorial=$claveeditorial;";
                ...
                echo "<a href='act_editorial.php' class='ui-btn ui-btn-icon-right ui-btn-inline ui-icon-back ui-btn-b ui-mini'>Regresar</a>";
