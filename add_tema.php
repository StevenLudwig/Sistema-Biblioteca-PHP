    ...
    <body>
        <div class="center" align="center">
            ...
            <?php
                ...
                echo "<table>";
                echo "<tr><th>Clave de tema</th><th>Tema</th></tr>";
                echo "<tr><td>".$clave."</td><td>".$nombre."</td></tr>";
                echo "</table>";
                
                // Realizando una consulta SQL
                $query = "insert into tema (clavetema,nombre) values ($clave,'$nombre');";
                ...
                echo "<a href='add_temas.php' class='ui-btn ui-btn-icon-right ui-btn-inline ui-icon-back ui-btn-b ui-mini'>Regresar</a>";
