    ...
    <body>
        <div class="center" align="center">
            ...
            <?php
                ...
                $query = "update autor set nombre='$nombre' where claveautor=$claveautor;";
                ...
                echo "<a href='act_autor.php' class='ui-btn ui-btn-icon-right ui-btn-inline ui-icon-back ui-btn-b ui-mini'>Regresar</a>";
