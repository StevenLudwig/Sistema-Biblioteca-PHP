    ...
    <body>
        <div class="center" align="center">
            ...
            <?php
                ...
                $query = "insert into escrito_por (clavelibro,claveautor) values ($clavelibro,$claveautor);";
                ...
                echo "<a href='add_escritor.php' class='ui-btn ui-btn-icon-right ui-btn-inline ui-icon-back ui-btn-b ui-mini'>Regresar</a>";
