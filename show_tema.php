    ...
    <div class="center" align="center">
    	<h1 align="center"><p>Temas de Libros</p></h1>
        	<form id="frm_filtro" method="post" action="">
                <label class="letra">Clave de tema:</label>
                    <select name="clavetema" class="letra">
                        <option selected="selected" value="">-Todos-</option>
                    <?php
                        $query = pg_query("SELECT clavetema FROM tema") or die('La consulta fallo:'.pg_last_error()); 
                        while($row = pg_fetch_array($query)){
                        ?>
                        <option value="<?=$row['clavetema']?>">
                            <?=$row['clavetema']?>
                        </option>
                    <?php
                            }
        ...
        <table cellpadding="0" cellspacing="0" id="data">
        	<thead>
            	<tr>
                    <th><span title="clavetema">Clave de tema</span></th>
