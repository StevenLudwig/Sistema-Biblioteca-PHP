    ...
    <body>
        <div class="center" align="center">
            ...
            <?php
                ...
                $query = "delete from socio where clavesocio=$clavesocio;";
                ...
                echo "<a href='del_socio.php' class='ui-btn ui-btn-icon-right ui-btn-inline ui-icon-back ui-btn-b ui-mini'>Regresar</a>";
