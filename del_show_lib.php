    ...
    <body>
        <div class="center" align="center">
            ...
            <?php
                ...
                $query = "delete from libro where clavelibro=$clavelibro;";
                ...
                echo "<a href='del_libro.php' class='ui-btn ui-btn-icon-right ui-btn-inline ui-icon-back ui-btn-b ui-mini'>Regresar</a>";
