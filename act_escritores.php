    ...
    <body>
        <div class="center" align="center">
            ...
            <?php
                ...
                $query = "update escrito_por set claveautor=$claveautor where clavelibro = $clavelibro;";
                ...
                echo "<a href='act_escritor.php' class='ui-btn ui-btn-icon-right ui-btn-inline ui-icon-back ui-btn-b ui-mini'>Regresar</a>";
