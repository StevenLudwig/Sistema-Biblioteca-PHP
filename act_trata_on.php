    ...
    <body>
        <div class="center" align="center">
            ...
            <?php
                ...
                $query = "update trata_sobre set clavetema=$clavetema where clavelibro = $clavelibro;";
                ...
                echo "<a href='act_trata_sobre.php' class='ui-btn ui-btn-icon-right ui-btn-inline ui-icon-back ui-btn-b ui-mini'>Regresar</a>";
