    ...
    <body>
        <div class="center" align="center">
            ...
            <?php
                ...
                $query = "delete from ejemplar where claveejemplar=$claveejemplar;";
                ...
                echo "<a href='del_ejemplar.php' class='ui-btn ui-btn-icon-right ui-btn-inline ui-icon-back ui-btn-b ui-mini'>Regresar</a>";
