    ...
    <body>
        <div class="center" align="center">
            ...
            <?php
                ...
                $query = "update tema set nombre='$nombre' where clavetema=$clavetema;";
                ...
                echo "<a href='act_tema.php' class='ui-btn ui-btn-icon-right ui-btn-inline ui-icon-back ui-btn-b ui-mini'>Regresar</a>";
